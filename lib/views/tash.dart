...
import 'package:tomo/widgets/update_task_dialog.dart';

import '../utils/colors.dart';
import '../widgets/delete_task_dialog.dart';

class todoso extends StatefulWidget {
  final String groupChatId;

  const todoso({required this.groupChatId, Key? key}) : super(key: key);

  @override
  State<todoso> createState() => _todosoState();
}


class _todosoState extends State<todoso> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: StreamBuilder<QuerySnapshot>(
        stream: fireStore.collection('groups').doc(widget.groupChatId).collection('tasks').snapshots(),

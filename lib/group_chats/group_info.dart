...
import 'package:tomo/group_chats/add_members.dart';
import 'package:tomo/group_chats/group_chat_screen.dart';
  ...
  Future onLeaveGroup() async {
    if (!checkAdmin()) {
      ...
      Navigator.of(context).pushAndRemoveUntil(
        MaterialPageRoute(builder: (_) => GrouptodoHomeScreen()),
        (route) => false
      );
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        valueColor: AlwaysStoppedAnimation<Color>(Color(0xFFFFF9EC)), // Color of the progress indicator
      ),
              )
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return ListTile(
                            ...
                            trailing: Text(
                                membersList[index]['isAdmin'] ? "Admin" : "member"),
                          );
                        },
                      ),
                    ),
